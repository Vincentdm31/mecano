...
<div class="container">
    ...
    <p class="txt-gl4 font-s8 mt-2">Liste des Interventions terminées</p>
            <form class="form-material" method="GET" action="searchInterventionFull">
                @csrf
                <div class="grix xs3">
                    <div class="form-field pos-xs1 col-xs2">
                        <input type="text" name="searchInterventionFull" id="searchInterventionFull" class="form-control txt-gl4" />

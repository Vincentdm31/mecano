...
<div class="container h100 d-flex">
    <div class="vself-center container card overflow-visible light-shadow-2 rounded-3 grey light-4">
        <div class="card-content p-0">
            ...
            <p class="m-0 txt-grey txt-light-4 p-3 font-s2 dark mb-5 rounded-tr0 rounded-bl0 rounded-tl3 rounded-br3">Déplacement ?</p>
            <div class="grix xs2 mb-4 p-3">
                ...
                <form action="{{ route('needMove')}}" method="POST">
                    ...
                    <button type="submit" class="btn dark txt-white small rounded-1 w100"><i class="fas fa-times"></i></button>
                </form>
            </div>
            @endif

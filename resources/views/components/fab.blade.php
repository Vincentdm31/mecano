...
<div class="fab fab-checker" id="fab" data-ax="fab">
  ...
  <div class="fab-menu">
    ...
    <form class="form-material h100" onsubmit="return confirm('Mettre l\'intervention en pause ?');" method="POST" action="{{ route('timeinterventions.store') }}">
      ...
      <button type="submit" class="btn shadow-1 circle grey light-4 txt-orange txt-dark-1 fab-item mb-3"><i class="fas fa-pause"></i></button>
    </form>
    ...
    <form class="form-material h100" onsubmit="return confirm('Reprendre l\'intervenion? ?');" method="POST" action="{{ route('timeinterventions.store') }}">
      ...
      <button type="submit" class="btn shadow-1 circle grey light-4 txt-green txt-dark-1 fab-item mb-3"><i class="fas fa-play"></i></button>
    </form>
    @endif
